...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./0-Cxj4eiRU.js')),
			__memo(() => import('./1-BplGgF_b.js')),
			__memo(() => import('./2-zKL9S6mU.js')),
			__memo(() => import('./3-CkvuT3g5.js')),
			__memo(() => import('./4-BeW3srR4.js'))
		],
		remotes: {
...
//# sourceMappingURL=manifest.js-CCJHhfAa.js.map
